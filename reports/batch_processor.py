...
class BatchShipmentProcessor:
    ...
    def _execute_tariff_query(
        ...
        JOIN I2TM_APP.TFF_T T ON T.TFF_ID = L.TFF_ID
        JOIN I2TM_APP.RATE_T R ON R.SRVC_CD = L.SRVC_CD 
            AND R.RATE_CD = L.RATE_CD 
            AND R.TFF_ID = L.TFF_ID
        JOIN I2TM_APP.RNG_rate_T RT ON R.RATE_ID = RT.RATE_ID
        JOIN I2TM_APP.CNCY_T C ON C.CNCY_TYP = R.CNCY_TYP
        WHERE T.MSTR_TFF_ID IN ('52742')
        AND ROWNUM <= 100
        """
